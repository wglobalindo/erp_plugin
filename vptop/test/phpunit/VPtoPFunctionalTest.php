...
/**
 * \file    test/phpunit/VPtoPFunctionalTest.php
 * \ingroup vptop
 ...
 * @package Testvptop
 */
class VPtoPFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/vptop/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('vptop/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/vptop/admin/about.php');
		$this->authenticate();
		return $this->assertContains('vptop/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('vptopwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modVPtoP_VPtoPTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modVPtoP_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
