...
class Utils
{
	 ...
	 *
	 * @param SupplierProposal $object Order object
	 * @param Product $prod Product to add
	 * @param int $qty Quantity of the product
	 * @throws Exception
	 */
	public static function addOrderLine(SupplierProposal $object, Product $prod, $qty)
	{
	...
	public static function addOrderLine_manual(SupplierProposal $object, $desc, $qty, $pu_ht = 0, $remise_percent = 0, $unit = 0)
	{
		$array_options =array('options_supplier'=>$object->socid, 'options_sp'=>$object->id, 'options_unit'=>$unit);
		// Insert line
		$result = $object->addline(
			$desc,
			'',
