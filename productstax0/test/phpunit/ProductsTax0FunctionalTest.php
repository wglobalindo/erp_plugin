...
/**
 * \file    test/phpunit/ProductsTax0FunctionalTest.php
...
/**
 * Class ProductsTax0FunctionalTest
 *
 ...
 *
 * @package Testproductstax0
 */
class ProductsTax0FunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modProductsTax0')->click();
		} else {
			// Disable the module
			$this->byHref('modProductsTax0')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/productstax0/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('productstax0/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/productstax0/admin/about.php');
		$this->authenticate();
		return $this->assertContains('productstax0/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('productstax0widget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modProductsTax0_ProductsTax0Triggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modProductsTax0_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
